/* pgc++ -g -fPIC -acc -mp -Minfo=accel -fast -shared -I./common -o laplace2d_acc laplace2d.cpp 
...
__device__ half __hmul(const half a, const half b);

int main(int argc, char** argv)
{
    half a = __float2half(0.2f);
    half b = __float2half(0.2f);

    half c = __float2half(0.2f);
    c = __hmul(a,b);
    printf("Jacobi relaxation Calculation:");
    int n = 4096;
    int m = 4096;
    int iter_max = 1000;
